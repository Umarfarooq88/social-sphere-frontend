'use client'
import {
 Day, Week, Month, Agenda, ScheduleComponent, ViewsDirective, ViewDirective, EventSettingsModel, ResourcesDirective, ResourceDirective, Inject, Resize, DragAndDrop
...
export default function Home() {
  ...
  return (
    <>
      ...
      <ScheduleComponent width='70%' height='550px' currentView='Day' selectedDate={new Date(2024, 3, 5)} eventSettings={eventSettings} group={group} >
        <ViewsDirective>
